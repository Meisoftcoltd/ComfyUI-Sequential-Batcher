...
* **Native LTX 2.3 Support:** Specific mathematical calculators (`AutoLoopCalculatorLTX` and `ResTool32xLTX`) have been added to ensure video batches comply with the strict DiT architecture decompression rules (resolutions strictly divisible by 32 and frame partitions of `8n + 1`).
